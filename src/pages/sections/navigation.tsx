...
const Navigation: React.FC<INavigation> = ({ children }) => {
  ...
  return (
    <>
      <div className="block md:block lg:hidden drawer">
        <input id="drawer-menu" type="checkbox" className="drawer-toggle" />
        <div className="drawer-content">

          {/* Navbar content */}
          <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 navbar w-full bg-base-300 shadow-lg">
          ...
          <progress className="progress progress-primary fixed mt-8 w-full h-1 z-100" value={scrollProgress} max="100" />
          <div className='mt-8'>
            {children}
          </div>
        </div>
