    ...
    return (
        <section className="max-w-6xl mx-auto w-full px-4 py-10">
            <div className="text-center mb-16">
                <h1 className="text-4xl font-bold mb-2 uppercase tracking-widest">Education</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                <div className="md:col-span-4 lg:col-span-4 p-8 rounded-3xl bg-base-200/40 border border-white/5 flex flex-col justify-between group hover:border-primary/30 transition-all">
                    <div>
                        <div className="flex justify-between items-start mb-4">
                            <h2 className="text-2xl font-black tracking-tight">Universitas Pendidikan Indonesia</h2>
                            <span className="badge badge-primary badge-outline px-4 py-3">2018 — 2022</span>
                        </div>
                        <p className="text-xl text-base-content/90 mb-1">Bachelor of Science (B.Sc.) — Material Physics</p>
                        <p className="text-base-content/60 mb-6 italic">Bandung, Indonesia</p>

                        <h6 className="text-sm italic tracking-wide leading-relaxed opacity-80 border-l-2 border-primary/40 pl-4">
                ...
                <div className="md:col-span-2 lg:col-span-2 p-8 rounded-3xl bg-primary text-primary-content flex flex-col justify-center items-center text-center shadow-xl shadow-primary/10 hover:border-primary/30">
                    <h3 className="text-lg font-bold uppercase tracking-widest mb-2">Bootcamp</h3>
                    <h2 className="text-2xl font-black mb-2">Makers Institute</h2>
                    <p className="opacity-90">Full Stack Web Development</p>
                ...
                <div className="md:col-span-1 lg:col-span-1 p-6 rounded-3xl bg-base-200/40 border border-white/5 flex flex-col items-center justify-center text-center hover:border-primary/30">
                    ...
                    <p className="text-3xl font-black text-primary">3.52</p>
                ...
                <div className="md:col-span-3 lg:col-span-3 p-6 rounded-3xl bg-neutral/10 border border-white/5 flex items-center gap-6 hover:border-primary/30">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-base-content/70 italic">"Mahasiswa Bidikmisi Berprestasi UPI 2020"</p>
                    </div>
                </div>
